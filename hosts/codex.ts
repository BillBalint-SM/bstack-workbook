...
const codex = defineHost({
  ...
  // Native independent reviewers are not recursive Codex CLI/model invocation.
  suppressedResolvers: [...CROSS_MODEL_RESOLVERS.filter(name => name !== 'REVIEW_ARMY'), ...GBRAIN_RESOLVERS],
