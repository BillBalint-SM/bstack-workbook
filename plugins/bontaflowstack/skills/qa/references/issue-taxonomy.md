...
8. **Auth boundaries** — Never sign the user out or switch accounts yourself. If the signed-out or other-role view matters, use a separately authorized visible sign-in flow and rerun the relevant packaged browser checks.
