...
description: Review a plan's problem, value and scope, with hold, reduction or explicitly chosen expansion and concrete implementation risks.
---

# plan-ceo-review

Default to holding the stated scope. Preserve modes HOLD, REDUCTION,
EXPANSION and SELECTIVE EXPANSION when requested. In expansion, distinguish
proposed, accepted and deferred ideas; never accept your own suggestion.
Challenge the premise, identify existing capabilities and compare the smallest
credible solution with a materially different alternative when helpful.
Include a practical first slice and measurable outcome. Research, independent
voices, diagrams and extra artifacts are driven by need, not mandatory rituals.
