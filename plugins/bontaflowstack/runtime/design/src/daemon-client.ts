...
export interface EnsureDaemonOptions {
   ...
   * DESIGN_DAEMON_STATE_FILE or .bfstack/design.json under the git root /
    ...
    if (health) {
      ...
      if (health.activeBoards > 0) {
        process.stderr.write(
          `[design-daemon] WARNING: existing daemon is bfstack ${health.version}; this CLI is ${expectedVersion}.\n` +
