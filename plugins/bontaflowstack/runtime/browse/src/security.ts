 ...
 * ~/.bfstack/security/session-state.json existed to carry classifier status
 ...
 * ~/.bfstack/security/decisions/ are unaffected, and the L4 sidecar reports
...
/**
 * Append the canary instruction to a system prompt. The agent is told never to
