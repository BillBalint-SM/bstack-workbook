...
export interface DesignSlopEntry {
  ...
  name: string;
  /** the doctrine line, bfstack voice (cat 9, checklist, consultation bullets) */
  prose: string;
  ...
  roles?: FontRole[];
  handoff?: Handoff;
  source: 'bfstack' | 'impeccable' | 'both';
...
export const DESIGN_SLOP_CATALOG: DesignSlopEntry[] = [
  ...
  },
  {
    ...
    handoff: 'layout', source: 'bfstack', legacyBlacklist: true,
  },
  {
    ...
    handoff: 'quieter', source: 'bfstack', legacyBlacklist: true,
  },
  {
  ...
  },
  {
    ...
    handoff: 'polish', source: 'bfstack', legacyBlacklist: true,
  },
  {
  ...
  },
  {
    ...
    handoff: 'clarify', source: 'bfstack', legacyBlacklist: true,
  },
  {
  ...
  },
  {
    ...
    handoff: 'typeset', source: 'bfstack', legacyBlacklist: true,
  },
  ...
  // ── bfstack-only slop tells: the LLM pass judges these; no detector id, so no brackets. ──
  {
    ...
    handoff: 'colorize', source: 'bfstack',
  },
  {
    ...
    category: 'imagery', kind: 'slop', detect: ['llm'], confidence: 'LOW', tier: 'ask', impact: 'medium',
    handoff: 'quieter', source: 'bfstack',
  },
  {
  ...
  },
  {
    ...
    category: 'scaffold', kind: 'slop', detect: ['llm'], confidence: 'LOW', tier: 'ask', impact: 'medium',
    handoff: 'clarify', source: 'bfstack',
  },
  {
  ...
  },
  {
    ...
    handoff: 'typeset', source: 'bfstack',
  },
  {
...
/** bfstack-only slop tells (no detector rule), minus the legacy lines: the LLM pass is the detector. */
