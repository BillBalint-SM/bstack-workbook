/**
 * bfstack-decision — event-sourced institutional decision memory.
 *
 ...
 * text can't carry instructions. This is the reliable
...
/** Resolve the per-project decision store paths. Bins pass slug + BFSTACK_HOME. */
export function decisionPaths(slug: string, bfstackHome?: string): DecisionPaths {
...
export function datamark(text: string): string {
  ...
  return text
    ...
    // angle-tag pass and are model native turn delimiters
