...
export function locateBinary(): string | null {
  // A selected plugin runtime must not silently use a different installation.
  if (process.env.GSTACK_ROOT) return findExecutable(join(process.env.GSTACK_ROOT, 'browse', 'dist', 'browse'));
